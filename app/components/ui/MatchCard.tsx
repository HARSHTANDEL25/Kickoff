...
export default function MatchCard({ fixture, league, teams, goals }: Fixture) {
    ...
    return (
        <Link href={`/match/${fixture.id}?league=${slug}`} className='block group'>
            <div className='glass rounded-2xl p-4 transition-all duration-200 hover:bg-white/6 cursor-pointer'>
